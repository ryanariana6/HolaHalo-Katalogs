<?php namespace App\Http\Controllers;
	...
	class AdminKatalogProdukController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "Katalog";
			$this->limit = "20";
			$this->orderby = "id,desc,kategori";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nama','name'=>'nama','type'=>'text','validation'=>'required|string|min:3|max:70|required','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
